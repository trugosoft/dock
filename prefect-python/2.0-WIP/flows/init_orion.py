...
SET_DEFAULT_STORAGE_URL = f'{ORION_SERVER_URL}/api/block_documents/1499dc8f-c48b-4535-afda-24d7e0f5dd42/set_default_storage_block_document'
...
def init_storage(storage_type: str = 'File Storage', name: str = 'minio_docker'):
    ...
    resp = session.post(SET_DEFAULT_STORAGE_URL.replace('1499dc8f-c48b-4535-afda-24d7e0f5dd42', block_id), json={})
    resp.raise_for_status()
    return block_id
